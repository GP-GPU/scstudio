...
p = subprocess.Popen([sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5]], stdout=subprocess.PIPE, stderr=subprocess.PIPE, universal_newlines=True)
...
if int(sys.argv[5]) == 0:
  result_files = glob.glob(sys.argv[4] + ".result*")
...
# $Id: checker_diff.py 1039 2011-02-15 17:15:11Z madzin $
